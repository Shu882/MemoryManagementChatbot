...
ChatLogic::ChatLogic() // constructor
{
    //// STUDENT CODE
    ////
...
//    {
//        delete *it;
//    } _nodes is vector of unique pointers, no explicit management is needed I suppose

    // delete all edges-- you don't need this anymore since they are smart pointers
